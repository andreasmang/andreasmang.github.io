...
<dt>Hours</dt><dd class="muted">Fall 2026: MW 2:00PM&ndash;3:00PM or by appointment (<a href="mailto:andreas.mang@tufts.edu">andreas.mang@tufts.edu</a>)</dd>
</dl>

<div class="social-links">
<a href="https://scholar.google.com/citations?user=CJc0_msAAAAJ" target="_blank" rel="noopener">{% include icon-scholar.html %} Google Scholar</a>
<a href="https://github.com/andreasmang" target="_blank" rel="noopener">{% include icon-github.html %} GitHub</a>
<a href="https://orcid.org/0000-0003-4605-3290" target="_blank" rel="noopener">{% include icon-orcid.html %} ORCID</a>
</div>
...
{% for item in sorted_news %}<li><span class="news-date">{{ item.date | date: "%b %Y" }}</span><span class="news-text">{{ item.text }}</span></li>
{% endfor %}</ul>

## Prospective Students & Advising

Information on open positions, graduate and undergraduate advising, and **letter-of-recommendation requests** is on the [advising page](/advising/). *Before emailing me about positions or recommendation letters, please read it.*
...
<p class="text-muted" style="margin-top:0.5rem;">For news from 2023 and earlier, see the <a href="/news/">news archive</a>.</p>
